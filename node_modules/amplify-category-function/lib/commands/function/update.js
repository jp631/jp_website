...
module.exports = {
    ...
    run: async (context) => {
        ...
        return amplify
            .serviceSelectionPrompt(context, constants_2.category, servicesMetadata, constants_1.chooseServiceMessageUpdate)
            .then(result => {
            ...
            return providerController.updateResource(context, constants_2.category, result.service);
        })
            .then(() => {
            context.print.info('');
        })
