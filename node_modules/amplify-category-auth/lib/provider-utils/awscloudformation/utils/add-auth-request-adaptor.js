...
exports.getAddAuthRequestAdaptor = void 0;
...
exports.getAddAuthRequestAdaptor = projectType => ({ serviceConfiguration: cognitoConfig, resourceName, }) => {
    var _a;
...
const oauthMap = (oauthConfig, requiredAttributes = []) => {
    ...
    return {
        ...
        AllowedOAuthFlows: oauthConfig.oAuthGrantType.toLowerCase(),
...
const socialProviderMap = (socialConfig = [], requiredAttributes = []) => {
    ...
    const result = {
        ...
        ...socialConfigMap,
        ...auth_questions_1.userPoolProviders(authProvidersUserPool, { requiredAttributes, ...socialConfigMap }),
    };
    return result;
};
const identityPoolMap = (idPoolConfig, projectType) => {
    if (!idPoolConfig)
        return {
...
const signinAttributeMap = {
    [amplify_headless_interface_1.CognitoUserPoolSigninMethod.USERNAME]: 'username',
...
//# sourceMappingURL=add-auth-request-adaptor.js.map