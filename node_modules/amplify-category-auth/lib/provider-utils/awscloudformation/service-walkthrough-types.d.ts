export declare type ServiceQuestionsResult = ServiceQuestionsBaseResult & OAuthResult & SocialProviderResult & IdentityPoolResult & PasswordPolicyResult & PasswordRecoveryResult & MfaResult & AdminQueriesResult;
...
export declare type UsernameAttributes = 'username' | 'email' | 'phone_number' | 'email, phone_number';
