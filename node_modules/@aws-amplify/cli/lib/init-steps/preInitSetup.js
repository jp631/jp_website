...
async function createAmplifySkeleton() {
    git_manager_1.insertAmplifyIgnore(amplify_cli_core_1.pathManager.getGitIgnoreFilePath(process.cwd()));
    const skeletonLocalDir = path.join(__dirname, '..', '..', 'templates', 'amplify-skeleton');
    const skeletonProjectDir = path.join(amplify_cli_core_1.pathManager.getAmplifyDirPath(process.cwd()));
